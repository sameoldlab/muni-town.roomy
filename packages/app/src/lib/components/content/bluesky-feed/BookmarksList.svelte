...
<div class="flex-1 flex flex-col h-full overflow-hidden">
  ...
  <div class="flex-shrink-0 p-6 border-b border-base-300 dark:border-base-700">
    <div class="flex items-center gap-4">
      ...
      <div class="flex-1 relative">
        <Icon
          icon="mdi:magnify"
          class="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/60 size-4"
        />
        <input
          type="text"
      ...
      <!-- View Mode Toggle -->
      <div
        class="flex rounded-md border border-base-200 dark:border-base-700 overflow-hidden"
      >
        <button
        ...
        <button
          ...
          class="px-3 py-2 text-sm transition-colors border-l border-base-200 dark:border-base-700 {viewMode ===
          'grid'
            ? 'bg-blue-500 text-white'
            : 'bg-base-50 dark:bg-base-800 hover:bg-base-100 dark:hover:bg-base-700'}"
          title="Grid view"
  ...
  <div class="flex-1 overflow-y-auto p-6">
    ...
    {:else if filteredBookmarks.length === 0}
      <div class="text-center py-8 text-base-content/60">
        ...
        <p class="text-sm mt-2">Try different keywords or clear your search</p>
      </div>
    {:else}
      <div
        class={viewMode === "grid"
            ...
            <div class="p-4">
              ...
              <div class="flex items-start justify-between mb-3">
                <div class="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  {:else}
                    <div
                      class="size-8 rounded-full bg-base-300 flex items-center justify-center flex-shrink-0"
                    >
              ...
              >
                <div class="flex items-center gap-2">
                  <span
                    class="inline-flex items-center gap-1 px-2 py-0.5 bg-accent-100 dark:bg-accent-900/30 text-accent-800 dark:text-accent-200 rounded-full"
                  >
  ...
  {#if actualBookmarks.length > 0}
    <div
      class="flex-shrink-0 px-6 py-3 border-t border-base-300 dark:border-base-700 bg-base-50 dark:bg-base-800/50"
    >
      <div
