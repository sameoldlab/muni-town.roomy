...
/**
 * Ask the appserver to re-apply the reference arbiter config on a space's
 * stewarded account. Requires admin access on the space. The appserver acts
 * as the arbiter's recovery admin to reset the config.
 *
 ...
 * `resetConfig` for the space and surfaces any arbiter error (e.g. an
