...
type RouteParams = { space: string };
type RouteId = '/(app)/space/[space]';
...
type LayoutRouteId = RouteId | "/(app)/space/[space]" | "/(app)/space/[space]/[channel]" | "/(app)/space/[space]/thread/[thread]"
type LayoutParams = RouteParams & { space?: string; channel?: string; thread?: string }
